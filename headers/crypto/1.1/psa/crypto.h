// SPDX-FileCopyrightText: Copyright 2018-2023 Arm Limited and/or its affiliates
 ...
 * @param output_length   Length ot the expected output.
 */
...
/**
 * @brief Edwards-curve digital signature algorithm with prehashing (HashEdDSA),
 *        using the Edwards25519 curve.
 */
#define PSA_ALG_ED25519PH ((psa_algorithm_t) 0x0600090B)

/**
 * @brief Edwards-curve digital signature algorithm with prehashing (HashEdDSA),
 *        using the Edwards448 curve.
 */
 ...
 *
 * @param alg             The key agreement algorithm to compute: a value of
...
/**
 * @brief Get the raw key agreement algorithm from a full key agreement
 *        algorithm.
 *
