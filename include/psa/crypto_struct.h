...
#else
#define PSA_KEY_AGREEMENT_IOP_INIT { 0, 0, PSA_KEY_ATTRIBUTES_INIT, 0 }
#endif
...
#else
#define PSA_GENERATE_KEY_IOP_INIT { 0, PSA_KEY_ATTRIBUTES_INIT, 0, 0 }
#endif
...
#else
#define PSA_EXPORT_PUBLIC_KEY_IOP_INIT { 0, 0, 0 }
#endif
